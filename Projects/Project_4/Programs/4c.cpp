...
void MetropolisSampling(int NSpins, int MCcycles, double Temperature, vec &ExpectationValues, int Random)
{
	...
	cout << "The total number of accepted configurations was " << accept << endl;
...
void WriteResultstoFile(int NSpins, int cycles, double temperature, vec ExpectationValues)
{
