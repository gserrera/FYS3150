...
int main(int argc, char* argv[])
{
	...
	cin >> NSpins;
	cout << "Introduce the number of Monte Carlo cycles: ";
	cin >> MCcycles;
	...
	// Start Monte Carlo computation, get expectation values and print them
	MetropolisSampling(NSpins, MCcycles, Temp, ExpectationValues);
	WriteResultstoFile(NSpins, MCcycles, Temp, ExpectationValues);
