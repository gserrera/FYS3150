...
public:
	...
	void VelocityVerlet(int dimension, int integration_points, double final_time, int print_number, double beta);
	double **setup_acc(int height, int width);
	void delete_acc(double **matrix);
	void GravitationalForce(planet &current, planet &other, double &Fx, double &Fy, double beta);
